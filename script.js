...
genBut.addEventListener('click', function () {
    ...
    gfx[33] ? c += `#shop_close, #shop_accept, #match-details-wnd .close-match-details-wrapper .close-match-details{background-image: url(${gfx[33]});}<br>` : null;
